...
<ul id="menu" class="nav">
  ...
  <li class="categories_li <?php if($_GET['com']=='news') echo ' activemenu' ?>" id="menu_dv"><a href="" title="" class="exp"><span>Dịch vụ</span><strong></strong></a>
    <ul class="sub">
  ...
  <li class="categories_li <?php if($_GET['com']=='product' || $_GET['com']=='order' || $_GET['com']=='excel') echo ' activemenu' ?>" id="menu2"><a href="" title="" class="exp"><span>Thiết kế</span><strong></strong></a>
    <ul class="sub">
  ...
  <li class="categories_li <?php if($_GET['com']=='news') echo ' activemenu' ?>" id="menu_tv"><a href="" title="" class="exp"><span>Tư vấn</span><strong></strong></a>
    <ul class="sub">
  ...
  <li class="categories_li <?php if($_GET['com']=='product' || $_GET['com']=='order' || $_GET['com']=='excel') echo ' activemenu' ?>" id="menu3"><a href="" title="" class="exp"><span>Công trình</span><strong></strong></a>
    <ul class="sub">
    ...
    <li class="categories_li <?php if($_GET['com']=='news' or $_GET['com']=='vnexpress') echo ' activemenu' ?>" id="menu_tt"><a href="" title="" class="exp"><span>Tin tức - Sự kiện</span><strong></strong></a>
      <ul class="sub">
    ...
    <li class="categories_li <?php if($_GET['com']=='news' or $_GET['com']=='vnexpress') echo ' activemenu' ?>" id="menu_dg"><a href="" title="" class="exp"><span>Đánh giá khách hàng</span><strong></strong></a>
      <ul class="sub">
    ...
    <li class="categories_li <?php if($_GET['com']=='news' or $_GET['com']=='vnexpress') echo ' activemenu' ?>" id="menu_mxh"><a href="" title="" class="exp"><span>Mạng xã hội</span><strong></strong></a>
      <ul class="sub">
