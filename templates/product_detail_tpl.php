              ...
              <div class="box_container">
                <div class="wap_pro">
                    <div class="zoom_slick">    
                        ...
                        <div class="slick">                
                            <img class='cloudzoom-gallery' src="resize/100x100/1/<?php if($row_detail['photo'] != NULL)echo _upload_sanpham_l.$row_detail['photo'];else echo 'images/noimage.gif';?>" data-cloudzoom ="useZoom:'.cloudzoom', image:'<?php if($row_detail['photo'] != NULL)echo _upload_sanpham_l.$row_detail['photo'];else echo 'images/noimage.gif';?>' ,zoomImage: '<?php if($row_detail['photo'] != NULL)echo _upload_sanpham_l.$row_detail['photo'];else echo 'images/noimage.gif';?>'" >
                            
                            <?php for($j=0,$count_hinhthem=count($hinhthem);$j<$count_hinhthem;$j++){?>
                                <img class='cloudzoom-gallery' src="resize/100x100/1/<?php if($hinhthem[$j]['thumb']!=NULL) echo _upload_hinhthem_l.$hinhthem[$j]['thumb']; else echo 'images/noimage.gif';?>" data-cloudzoom ="useZoom:'.cloudzoom', image:'<?php if($hinhthem[$j]['photo']!=NULL) echo _upload_hinhthem_l.$hinhthem[$j]['photo']; else echo 'images/noimage.gif';?>' ,zoomImage: '<?php if($hinhthem[$j]['photo']!=NULL) echo _upload_hinhthem_l.$hinhthem[$j]['photo']; else echo 'images/noimage.gif';?>'" >
                            <?php } ?>
                        </div><!--.slick-->
                        <?php } ?>
                    </div><!--.zoom_slick--> 
